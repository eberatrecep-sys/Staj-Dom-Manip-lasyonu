...
public class AuthController : ControllerBase
{
    ...
    public async Task<IActionResult> Login([FromBody] LoginDto dto)
    {
        ...
        catch (Exception ex)
        {
            ...
            return StatusCode(505, new { error = "Sunucu hatası: " + ex.Message + " " + ex.InnerException?.Message });
        }
    }
    ...
    public async Task<IActionResult> ConfirmAccountDeletion([FromBody] ConfirmDeleteAccountDto dto)
    {
        try
        {
            ...
            var result = await _authService.ConfirmAccountDeletionAsync(userId, dto.Otp);
            return Ok(result);
        }
